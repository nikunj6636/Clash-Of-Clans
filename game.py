...
from characters import spawnKing, spawnBarbarian, move_barbarians, spawnArcher, spawnStealthArcher, move_archers, move_stealthArchers, spawnDragon, move_dragons, spawnBalloon, move_balloons, spawnHealer, move_healers, clearTroops
...
# King is added in the character.py file
...
while(True):
    ...
    if(V.check_if_game_over(King) == 1):  # next level
        ...
        print('Victory')
        break
    elif(V.check_if_game_over(King) == 3):  # Game ends
        os.system('clear')
        print('Defeat')
        break
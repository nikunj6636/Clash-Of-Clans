...
def printMap(V):
    ...
    for arch in stealthArchers:
        a= 2*arch.position[0]
        b = 2*arch.position[1]
        map_matrix[a][b] = archColor(arch) + Fore.BLACK + 'SA'
        map_matrix[a+1][b] = archColor(arch) + Fore.BLACK + '  '
        map_matrix[a][b+1] = archColor(arch) + Fore.BLACK + 'RC'
        map_matrix[a+1][b+1] = archColor(arch) + Fore.BLACK + 'HE'
    ...
    for arch in healers:
        a= 2*arch.position[0]
        b = 2*arch.position[1]
        map_matrix[a][b] = archColor(arch) + Fore.BLACK + 'HE'
        map_matrix[a+1][b] = archColor(arch) + Fore.BLACK + '  '
        map_matrix[a][b+1] = archColor(arch) + Fore.BLACK + 'AL'
        map_matrix[a+1][b+1] = archColor(arch) + Fore.BLACK + 'ER'
